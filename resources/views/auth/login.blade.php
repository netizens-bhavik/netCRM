...
<html
  ...
  <head>
    ...
    <!-- Icons -->
    <link rel="stylesheet" href="{{url('layout/assets/vendor/fonts/fontawesome.css')}}" />
    <link rel="stylesheet" href="{{url('layout/assets/vendor/fonts/tabler-icons.css')}}" />
    <link rel="stylesheet" href="{{url('layout/assets/vendor/fonts/flag-icons.css')}}" />

    <!-- Core CSS -->
    <link rel="stylesheet" href="{{url('layout/assets/vendor/css/rtl/core.css')}}" class="template-customizer-core-css" />
    <link rel="stylesheet" href="{{url('layout/assets/vendor/css/rtl/theme-default.css')}}" class="template-customizer-theme-css" />
    ...
    <link rel="stylesheet" href="{{url('layout/assets/vendor/libs/typeahead-js/typeahead.css')}}" />
    <!-- Vendor -->
    <link rel="stylesheet" href="{{url('layout/assets/vendor/libs/@form-validation/form-validation.css')}}" />

    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="{{url('layout/assets/vendor/css/pages/page-auth.css')}}" />

    <!-- Helpers -->
    <script src="{{url('layout/assets/vendor/js/helpers.js')}}"></script>
    <!--! Template customizer & Theme config files MUST be included after core stylesheets and helpers.js in the <head> section -->
    <!--? Template customizer: To hide customizer set displayCustomizer value false in config.js.  -->
    <script src="{{url('layout/assets/vendor/js/template-customizer.js')}}"></script>
  ...
  <body>
    ...
    <script src="{{url('layout/assets/vendor/libs/i18n/i18n.js')}}"></script>
    <script src="{{url('layout/assets/vendor/libs/typeahead-js/typeahead.js')}}"></script>
    <script src="{{url('layout/assets/vendor/js/menu.js')}}"></script>

    <!-- endbuild -->

    <!-- Vendors JS -->
    <script src="{{url('layout/assets/vendor/libs/@form-validation/popular.js')}}"></script>
    <script src="{{url('layout/assets/vendor/libs/@form-validation/bootstrap5.js')}}"></script>
    <script src="{{url('layout/assets/vendor/libs/@form-validation/auto-focus.js')}}"></script>

    <!-- Main JS -->
    <script src="{{url('layout/assets/js/main.js')}}"></script>

    <!-- Page JS -->
    <script src="{{url('layout/assets/js/pages-auth.js')}}"></script>
  </body>
</html>
